...
module.exports = {
  ...
  module: {
    ...
    rules: [
      ...
      // 只有js不在node_modules包的时候，才使用babel-loader
      // 需要配置@babel/preset-env 才能将翻译的语法正确转换成es5
      // targets可以指定浏览器版本
      {
        test: /\.js$/,
        exclude: /node_modules/,
        loader: 'babel-loader',
        // options可以配置到.babelrc文件中去
        /*options: {
          ...
          // 如果写的是UI库代码或者类库代码使用
          // 如果corejs:2 则需要安装对应的包 @babel/runtime-corejs2
          // 可以有效避免@babel/polyfill所带来的全局污染的好处
          plugins: [
            [
